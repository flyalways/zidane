...
#define	TFT_H_Size	128//屏的水平大小
#define	TFT_V_Size	160//屏的垂直大小
...
#define	MediaIconID		21	// Media类型:NAND/USB/SD
        #define MediaIcon_H_Size	    22    //在音乐时该图标的位置
	#define	MediaIcon_V_Size	    12
	#define	MediaIcon_X_Pos		0
	#define	MediaIcon_Y_Pos		0

	#define MediaIcon_Mem_H_Size	    22    //在存储信息查询时该图标的位置
	#define	MediaIcon_Mem_V_Size	    12
	#define	MediaIcon_Mem_X_Pos		0
	#define	MediaIcon_Mem_Y_Pos		0
#define MusicTypeID	         22	//播放文件类型:MP3/WMA/APE/MP4/JPG
	#define	MusicType_H_Size	15 
	#define	MusicType_V_Size	7  
	#define	MusicType_X_Pos		37
	#define	MusicType_Y_Pos		133
/*
#define	VOLAdj1ID		     23	 
...
#define	MemInfoNumID	    11     //存储容量信息
    ...
    #define	MemInfoNUM_X_Pos    50
    #define	MemInfoNUM_Y_Pos    52
	#define MenInfoNUM_BaseOffset 23
///////////////////   
...
#define	FMORSONG_BG	31  //FM或者歌曲数字选择的背景
	#define	FMORSONG_BG_H_Size	100
	#define	FMORSONG_BG_V_Size	75
...
#define WordColor_FileName	    0x0000
#define WordColorBG_FileName	0xFFFF //文件名的背景颜色
#define Start_X_FileName	    34
#define Start_Y_FileName 	    74
#define FileName_Width	  	    85//文件显示的宽度
...
#define FullLRC_Start1_Y				8//第一句歌词的起始位置x
#define FullLRC_Width1					112//第一句歌词的显示宽度
...
#define FullLRC_Start2_Y				88//第二句歌词的起始位置x
#define FullLRC_Width2					112//第二句歌词的显示宽度
...
#define FW_Ver_Start_X                  35
#define FW_Ver_Start_Y                  50
#define FW_Data_Start_X              25
