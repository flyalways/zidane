...
void TFT_init(void)
{
	...
	LCD_Write_OneData( 0x00); 
	LCD_Write_OneData( 0x03);  //  hei-bai 00  01  03  06
	USER_DelayDTms(100);
	LCD_Write_Command( 0x00); 
	...
	LCD_Write_Command( 0x14); 
 	LCD_Write_OneData( 0x2f);  //shui wen
 	LCD_Write_OneData( 0x1d);  //shui wen 
	USER_DelayDTms(100);
	LCD_Write_Command( 0x00); 
