...
#define WORD_HI_BYTE(a)		((U8 *)&(a))[0]  //20090318				//!< for color turnkey //20090309 chiayen add for color  
#define WORD_LO_BYTE(a)		((U8 *)&(a))[1]  //20090318				//!< for color turnkey //20090309 chiayen add for color 
...
#define K_COUNTER_DIRNUM				11
	...
	#define D_TxtBuffLimit		100		//gc_TxtBuf[100]
	
	#define Buffer_Font			(XBYTE[0x8600])		//512 byte tmp buffer for HZK display 

	//gc_LrcDisplayBuf[100] 0x8E00~0x8E3F 
...
//======================================================
#define C_LKey_Play                 C_Key_Play|0x10
#define C_LKey_Mode                 C_Key_Mode|0x10
#define C_LKey_Next                 C_Key_Next|0x10
#define C_LKey_Prev                 C_Key_Prev|0x10
#define C_LKey_Volup                C_Key_Volup|0x10
#define C_LKey_Voldn                C_Key_Voldn|0x10
#define C_LKey_Rec                  C_Key_Rec|0x10
#define C_LKey_Vol	 				C_Key_Vol|0x10
...
#define MAX_REPEATKEYDELAY 			36  //16
...
#define TASK_PHASE_RECACT           0x05
#define TASK_PHASE_FASTFWD          0x03
#define TASK_PHASE_FASTREV          0x04
...
#define C_TuneVolFreq   0x10  

#define C_PlayModeChg	0x13  //chiayen0807
#define C_MainMenu		0x14
#define C_PowerOff		0x15

#define C_PlayChgUp		0x16	//add home
#define C_PlayChgDn		0x17
...
#define C_JpegInit      0x01
#define C_JpegProc		0x02
#define C_JpegPause  	0x03
#define C_JpegStop      0x04
#define C_JpegEndfile   0x05
#define C_JpegNext		0x06
#define C_JpegPrev      0x07
#define C_JpegUpLevel   0x08
#define C_JpegMenu		0x09  //20090331
...
#define C_MjpegMenu		0x0E  //200900331

#define C_MjpegChgUp	0x18	//add home
#define C_MjpegChgDn	0x19
...
#define CLOCK_MODE_12_12_19		8
#define CLOCK_MODE_24_24_24		1
#define CLOCK_MODE_24_24_48		2
#define CLOCK_MODE_39_39_78		3
#define CLOCK_MODE_12_12_72		4	// victor_power_fine_tune 081031
#define CLOCK_MODE_24_24_72		5
#define CLOCK_MODE_72_72_72		6
#define CLOCK_MODE_72_72_24		7
#define CLOCK_MODE_12_12_48		9	//odin20081024, wma clock fine tune
#define CLOCK_MODE_42_42_84		10	//Jimi 081222 for APE

#define CLOCK_MODE_XTL			0
#define CLOCK_MODE_MP3			2
#define CLOCK_MODE_MP3L			2
#define CLOCK_MODE_WMA			3
//#define CLOCK_MODE_JPEG			4
#define CLOCK_MODE_MJPEG		5
#define CLOCK_MODE_USB			6
...
typedef struct DSP_GLOBAL_ {
	...
	U8	sc_frame_rate;	//Added by Jimi 090410
	U16	sw_frm_cnt;
	U16	sw_kbyte_per_sec;
...
#define	LRC_DISPLAY_LYRICS_CHARNUMBER	120
#define	D_LrcBuffLimit 		120	
