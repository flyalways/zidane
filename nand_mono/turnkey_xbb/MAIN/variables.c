...
xdata	U16	gw_nCompressionLevel;
...
xdata	U16	gw_TotalNumber=0;                   // NR of file and dir: gs_DIRtable[tw_DirIndex].w_file_folder_num
...
xdata	U16	gw_DIRtableIndex=0;                 // Index in dir table: gs_DIRtable[]
