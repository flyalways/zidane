...
//========= Dir_Process =========
//extern void Get_TotalNumber(U16 tw_DirIndex);
...
extern void USER_WriteReserveBlock_DIR(U8 tc_PageNum);
extern void USER_Read512BReserveBlock_DIR(U16 DirIndex);
extern void USER_Read2KBReserveBlock_DIR(U16 DirIndex);
