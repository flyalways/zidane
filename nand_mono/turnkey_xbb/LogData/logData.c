...
void USER_GetSettingInfo(void)
{
	...
	gc_RepPlayMode_Nor=gc_PlayRecordDataBuf[2];
	gc_RepPlayMode_Dir=gc_PlayRecordDataBuf[21];
	gc_RepPlayMode = gc_RepPlayMode_Nor;
//	=gc_PlayRecordDataBuf[22];
	gc_language_offset=gc_PlayRecordDataBuf[22];
...
void USER_FillSettingInfo(void)
{
	...
	gc_PlayRecordDataBuf[2] = gc_RepPlayMode_Nor;
	gc_PlayRecordDataBuf[21] = gc_RepPlayMode_Dir;
...
//	gc_PlayRecordDataBuf[22] = gc_CurrentHZK;
	gc_PlayRecordDataBuf[22] = gc_language_offset;
}
