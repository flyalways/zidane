...
#define	PlayTimeID		    7	//歌曲播放的时间进度
	#define	PlayTime_H_Size		6
	#define	PlayTime_V_Size		10
	#define	PlayTime_X_Pos		105
	#define	PlayTime_Y_Pos		27	
	#define	SecondOffset		4	// ":"的宽度
#define	BitRateID	      	8	// 比特率BitRate	
	#define	BitRate_H_Size		6
	#define	BitRate_V_Size		10
	#define	BitRate_X_Pos		98
	#define	BitRate_Y_Pos		102 
...
#define	FM_FreqID		10	//播放界面FM的数字显示
	#define	FM_Freq_H_Size		6
	#define	FM_Freq_V_Size		10
	#define	FM_Freq_X_Pos		24
	#define	FM_Freq_Y_Pos		6
	#define	FreqDotOffset		2	// "." width
...
#define	PlayIconID		14	//播放状态的显示 Play/Pause/Stop
    #define	PlayIcon_H_Size 	20
	#define	PlayIcon_V_Size 	20
	#define	PlayIcon_X_Pos		8
	#define	PlayIcon_Y_Pos		105
#define	PlayModeIconID	15	// 循环模式：NORMAL/Repeat-1/Repeat-All
	#define	PlayModeIcon_H_Size	14
	#define	PlayModeIcon_V_Size	13
	#define	PlayModeIcon_X_Pos	25
	#define	PlayModeIcon_Y_Pos	20    
#define PlayRatioBarID	16	//播放进度显示
	#define	PlayRatioBarNum		78
	#define	PlayRatioBar_H_Size	77
	#define	PlayRatioBar_V_Size	1
	#define	PlayRatioBar_X_Pos	81
	#define	PlayRatioBar_Y_Pos	121
#define	EQIconID		17	// EQ图标?Normal/DBB/JAZZ...
	#define	EQIcon_H_Size		30
	#define	EQIcon_V_Size		15
	#define	EQIcon_X_Pos		94
...
#define	MediaIconID		21	// Media类型:NAND/USB/SD
	#define MediaIcon_H_Size	30 //在音乐时该图标的位置
	#define	MediaIcon_V_Size	15
	#define	MediaIcon_X_Pos		127
	#define	MediaIcon_Y_Pos		3   
...
#define MusicTypeID	         22	//播放文件类型:MP3/WMA/APE/MP4/JPG
	#define	MusicType_H_Size	30
	#define	MusicType_V_Size	15
	#define	MusicType_X_Pos		60
	#define	MusicType_Y_Pos		3
/*
#define	VOLAdj1ID		     23	 
...
//////////////
#define	MemInfoNumID	    6     //存储容量信息 
#define	MemInfoNUM_H_Size	6
...
#define WordColor_FileName	    0x3B9F
#define WordColorBG_FileName	0xBF7F //文件名的背景颜色
#define Start_X_FileName	    63
#define Start_Y_FileName 	    59
#define FileName_Width	  	    90//文件显示的宽度
