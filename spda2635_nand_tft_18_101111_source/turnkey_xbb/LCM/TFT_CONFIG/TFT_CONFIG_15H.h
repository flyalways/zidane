...
#define	BitRateID	      	8	// 比特率BitRate	
    ...
    #define BitRate_gap         1//两个显示数字之间的间隔
...
#define	MediaIconID		21	// Media类型:NAND/USB/SD
	#define MediaIcon_H_Size	22   //在音乐播放时该图标的位置
...
#define WordColorBG_FileName	0xFFFF	//0xBF7F	// //文件名的背景颜色
#define Start_X_FileName	    35
#define Start_Y_FileName 	    59
#define FileName_Width	  	    87//文件显示的宽度
...
#define FolderName_Width	  	    120//文件显示的宽度
...
#define DIR_Length                  (TFT_H_Size-Start_X_DIR-2)//离右边距5个像素点显示的长度
#define DIR_High                       20
...
#define FullLRC_Width1					120//第一句歌词的显示宽度
...
#define FullLRC_Width2					120//第二句歌词的显示宽度
